...
(2)~three critical manifolds reconciling four contradictory studies;
(3)~a re-entrant synchronization prediction;
(4)~a $\sigma$-scaling law answering \citet{Muolo2025}'s open question;
(5)~the mapping $K_3^{\mathrm{eff}}\!=\!K_2^2\tau/4$ delineating physically
reachable regions; and (6)~validation via $>10^5$ GPU simulations.
