...
(\Cref{app:r2}) is confirmed numerically for large $N$, with deviations
$|r_2 - r_1^2|\sim\Order(1/\sqrt{N})$ as expected from finite-size
fluctuations.  The ratio $r_2/r_1^2$ shows maximal deviation near the phase
boundary (critical fluctuations) and for negative $K_3$ (cluster formation).
