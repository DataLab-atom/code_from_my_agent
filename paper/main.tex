...
\paragraph{Experiments 6--7: Chimera search and distribution effects.}
No chimera states were found across 15 $(K_2,K_3)$ configurations
($N\!=\!500$), confirming that higher-order interactions alone cannot generate
chimeras in all-to-all networks.
Comparing Gaussian, Lorentzian, and uniform distributions: $\Kc$ depends on
$g(0)$ as predicted (Gaussian: $1.28$, uniform: $1.81$), and $K_3$-sensitivity
is weak ($<\!10\%$), consistent with \Cref{prop:onset-independence}.
