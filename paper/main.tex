...
\begin{remark}[Lorentzian vs.\ Gaussian]
  ...
  both distributions.  Higher-order (nonlinear) predictions from
  \eqref{eq:r-dynamics} are exact for the Lorentzian and approximate for the
  Gaussian~\citep{OttAntonsen2008}.
\end{remark}
